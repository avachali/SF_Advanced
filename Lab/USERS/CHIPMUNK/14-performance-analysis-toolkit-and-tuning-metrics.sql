...
ALTER WAREHOUSE CHIPMUNK_query_wh SET WAREHOUSE_SIZE = SMALL;
...
SHOW PARAMETERS IN WAREHOUSE CHIPMUNK_query_wh;
...
ALTER WAREHOUSE CHIPMUNK_query_wh SET STATEMENT_TIMEOUT_IN_SECONDS = 30;
...
ALTER WAREHOUSE CHIPMUNK_query_wh UNSET STATEMENT_TIMEOUT_IN_SECONDS;
...
ALTER SESSION SET QUERY_TAG = 'CHIPMUNK_join_test';
