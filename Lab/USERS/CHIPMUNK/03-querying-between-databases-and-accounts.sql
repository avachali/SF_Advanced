...
ALTER WAREHOUSE CHIPMUNK_wh SET WAREHOUSE_SIZE=Medium;
USE WAREHOUSE CHIPMUNK_wh;
USE SCHEMA CHIPMUNK_db.myschema;
...
SELECT c.c_custkey, c.c_name, o.o_orderstatus, o.o_orderpriority
  FROM snowflake_sample_data.tpch_sf100.customer c JOIN CHIPMUNK_db.myschema.orders_ctas o ON c.c_custkey=o.o_custkey;
