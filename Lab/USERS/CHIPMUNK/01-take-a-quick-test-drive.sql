...
CREATE DATABASE CHIPMUNK_db;
CREATE SCHEMA CHIPMUNK_db.myschema;
CREATE WAREHOUSE CHIPMUNK_wh INITIALLY_SUSPENDED=TRUE AUTO_SUSPEND=300;
CREATE WAREHOUSE CHIPMUNK_wh_small WAREHOUSE_SIZE=SMALL INITIALLY_SUSPENDED=TRUE AUTO_SUSPEND=300;
CREATE WAREHOUSE CHIPMUNK_wh_large WAREHOUSE_SIZE=LARGE INITIALLY_SUSPENDED=TRUE AUTO_SUSPEND=300;
