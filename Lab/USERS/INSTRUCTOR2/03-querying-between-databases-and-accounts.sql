...
ALTER WAREHOUSE INSTRUCTOR2_wh SET WAREHOUSE_SIZE=Medium;
USE WAREHOUSE INSTRUCTOR2_wh;
USE SCHEMA INSTRUCTOR2_db.myschema;
...
ALTER WAREHOUSE INSTRUCTOR2_wh SUSPEND;
...
SELECT c.c_custkey, c.c_name, o.o_orderstatus, o.o_orderpriority
  FROM snowflake_sample_data.tpch_sf100.customer c JOIN INSTRUCTOR2_db.myschema.orders_ctas o ON c.c_custkey=o.o_custkey;
