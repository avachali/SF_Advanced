...
SHOW WAREHOUSES LIKE 'INSTRUCTOR2%';
...
ALTER WAREHOUSE INSTRUCTOR2_LOAD_WH SET AUTO_SUSPEND = 60;
...
--         If you get the message, Invalid State. Warehouse INSTRUCTOR2_LOAD_WH
...
ALTER WAREHOUSE INSTRUCTOR2_QUERY_WH SET WAREHOUSE_SIZE = 'X-LARGE';

SHOW WAREHOUSES LIKE 'INSTRUCTOR2_QUERY_WH';
...
ALTER WAREHOUSE INSTRUCTOR2_QUERY_WH SET WAREHOUSE_SIZE=XLARGE;
...
CREATE OR REPLACE WAREHOUSE INSTRUCTOR2_SCALE_OUT_WH 
...
SHOW WAREHOUSES LIKE 'INSTRUCTOR2_SCALE_OUT_WH';
