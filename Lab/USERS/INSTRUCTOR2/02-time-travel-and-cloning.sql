...
CREATE DATABASE IF NOT EXISTS INSTRUCTOR2_CLONE_DB;
CREATE OR REPLACE SCHEMA INSTRUCTOR2_lab;
USE SCHEMA INSTRUCTOR2_lab;
CREATE TABLE nation CLONE training_db.traininglab.nation;


-- 2.1.2   Use the UNDROP command on a table.

SHOW TABLES IN SCHEMA INSTRUCTOR2_lab;

DROP TABLE INSTRUCTOR2_lab.NATION;
...
SHOW SCHEMAS IN database INSTRUCTOR2_CLONE_DB;

DROP SCHEMA INSTRUCTOR2_lab;
SHOW SCHEMAS IN database INSTRUCTOR2_CLONE_DB;

UNDROP SCHEMA INSTRUCTOR2_lab;
SHOW SCHEMAS IN database INSTRUCTOR2_CLONE_DB;


-- 2.1.4   Use the UNDROP command on a database.

SHOW DATABASES STARTS WITH 'INSTRUCTOR2';

DROP database INSTRUCTOR2_CLONE_DB;
SHOW DATABASES STARTS WITH 'INSTRUCTOR2';

UNDROP database INSTRUCTOR2_CLONE_DB;
SHOW DATABASES STARTS WITH 'INSTRUCTOR2';
...
USE DATABASE INSTRUCTOR2_CLONE_DB;
USE SCHEMA INSTRUCTOR2_lab;
USE WAREHOUSE INSTRUCTOR2_wh;
ALTER WAREHOUSE INSTRUCTOR2_wh set warehouse_size=small;
