...
CREATE DATABASE INSTRUCTOR2_prod;
CREATE SCHEMA INSTRUCTOR2_prod.sales;
...
CREATE ROLE INSTRUCTOR2_dba;
CREATE ROLE INSTRUCTOR2_dev;
CREATE ROLE INSTRUCTOR2_elt;
CREATE ROLE INSTRUCTOR2_analyst;


-- 5.1.3   Grant each of these roles to SYSADMIN, to create the first part of
--         the hierarchy.

GRANT ROLE INSTRUCTOR2_dba TO ROLE SYSADMIN; 
GRANT ROLE INSTRUCTOR2_dev TO ROLE SYSADMIN; 
GRANT ROLE INSTRUCTOR2_elt TO ROLE SYSADMIN; 
GRANT ROLE INSTRUCTOR2_analyst TO ROLE SYSADMIN; 
...
GRANT ROLE INSTRUCTOR2_dba
           ,INSTRUCTOR2_dev
           ,INSTRUCTOR2_elt
           ,INSTRUCTOR2_analyst TO USER INSTRUCTOR2; 


-- 5.1.5   Create the object roles, which will be assigned privileges to access
--         objects.

CREATE ROLE INSTRUCTOR2_read;
CREATE ROLE INSTRUCTOR2_ins_del;
CREATE ROLE INSTRUCTOR2_create_objects; 
CREATE ROLE INSTRUCTOR2_manage_db;


-- 5.1.6   Link the object roles together so privileges flow up through those
--         roles.

GRANT ROLE INSTRUCTOR2_read TO ROLE INSTRUCTOR2_ins_del;
GRANT ROLE INSTRUCTOR2_ins_del TO ROLE INSTRUCTOR2_create_objects;
GRANT ROLE INSTRUCTOR2_create_objects TO ROLE INSTRUCTOR2_manage_db;
...
GRANT ROLE INSTRUCTOR2_read TO ROLE INSTRUCTOR2_analyst;
GRANT ROLE INSTRUCTOR2_ins_del TO ROLE INSTRUCTOR2_elt;
GRANT ROLE INSTRUCTOR2_create_objects TO ROLE INSTRUCTOR2_dev;
GRANT ROLE INSTRUCTOR2_manage_db TO ROLE INSTRUCTOR2_dba;
...
GRANT USAGE ON DATABASE INSTRUCTOR2_prod to ROLE INSTRUCTOR2_read;

GRANT USAGE ON ALL SCHEMAS IN DATABASE INSTRUCTOR2_prod to ROLE INSTRUCTOR2_read;
GRANT USAGE ON FUTURE SCHEMAS IN DATABASE INSTRUCTOR2_prod to ROLE INSTRUCTOR2_read;

--         Because the READ role’s privileges are rolled up the hierarchy, all
--         object roles now have USAGE privileges on the database INSTRUCTOR2_PROD,
...
GRANT SELECT ON FUTURE TABLES IN DATABASE INSTRUCTOR2_prod TO ROLE INSTRUCTOR2_read;
GRANT SELECT ON FUTURE VIEWS IN DATABASE INSTRUCTOR2_prod TO ROLE INSTRUCTOR2_read;


-- 5.1.10  Grant privileges to the INS_DEL role.

GRANT INSERT, UPDATE, DELETE ON FUTURE TABLES IN DATABASE INSTRUCTOR2_prod
  TO ROLE INSTRUCTOR2_ins_del;
...
GRANT CREATE TABLE
     ...
     ,CREATE FUNCTION
     ,CREATE PROCEDURE
  ON ALL SCHEMAS IN DATABASE INSTRUCTOR2_prod TO ROLE INSTRUCTOR2_create_objects;
...
GRANT CREATE TABLE
     ...
     ,CREATE FUNCTION
     ,CREATE PROCEDURE
  ON FUTURE SCHEMAS IN DATABASE INSTRUCTOR2_prod TO ROLE INSTRUCTOR2_create_objects;
...
GRANT MODIFY
     ,MONITOR
     ,CREATE SCHEMA
ON DATABASE INSTRUCTOR2_prod 
TO ROLE INSTRUCTOR2_manage_db;
...
SHOW GRANTS OF ROLE INSTRUCTOR2_dba;
SHOW GRANTS OF ROLE INSTRUCTOR2_analyst;
SHOW GRANTS OF ROLE INSTRUCTOR2_elt;
SHOW GRANTS OF ROLE INSTRUCTOR2_dev;
...
SHOW GRANTS OF ROLE INSTRUCTOR2_read;
SHOW GRANTS OF ROLE INSTRUCTOR2_ins_del;
SHOW GRANTS OF ROLE INSTRUCTOR2_create_objects;
SHOW GRANTS OF ROLE INSTRUCTOR2_manage_db;


-- 5.2.3   Verify the grants on the INSTRUCTOR2_PROD database.

SHOW GRANTS ON DATABASE INSTRUCTOR2_prod;
...
CREATE WAREHOUSE IF NOT EXISTS INSTRUCTOR2_elt_wh
  WAREHOUSE_SIZE=XSmall
  INITIALLY_SUSPENDED=TRUE
  AUTO_SUSPEND=60;

CREATE WAREHOUSE IF NOT EXISTS INSTRUCTOR2_small_query_wh
   WAREHOUSE_SIZE=Small
   INITIALLY_SUSPENDED=TRUE
   AUTO_SUSPEND=600;

CREATE WAREHOUSE IF NOT EXISTS INSTRUCTOR2_large_query_wh
   WAREHOUSE_SIZE=Large
   INITIALLY_SUSPENDED=TRUE
   AUTO_SUSPEND=1200;

CREATE WAREHOUSE IF NOT EXISTS INSTRUCTOR2_mc_wh
...
GRANT USAGE ON WAREHOUSE INSTRUCTOR2_elt_wh TO ROLE INSTRUCTOR2_ins_del;
GRANT USAGE ON WAREHOUSE INSTRUCTOR2_small_query_wh TO ROLE INSTRUCTOR2_read;
GRANT USAGE ON WAREHOUSE INSTRUCTOR2_large_query_wh TO ROLE INSTRUCTOR2_read;
GRANT USAGE ON WAREHOUSE INSTRUCTOR2_mc_wh TO ROLE INSTRUCTOR2_read;
...
SHOW SCHEMAS IN DATABASE INSTRUCTOR2_prod;

--         You should see that the PUBLIC and SALES schemas are owned by
--         SYSADMIN. INFORMATION_SCHEMA does not have an owner, which is
--         expected.

-- 5.4.2   Transfer ownership of the SALES schema to the INSTRUCTOR2_MANAGE_DB role.
--         The company wants centralized management, and since INSTRUCTOR2_manage_db
--         can create schemas, it should own all schemas.

USE ROLE SYSADMIN;
GRANT OWNERSHIP ON SCHEMA INSTRUCTOR2_prod.sales TO ROLE INSTRUCTOR2_manage_db COPY CURRENT GRANTS; 
...
ALTER SCHEMA INSTRUCTOR2_prod.sales ENABLE MANAGED ACCESS;
...
USE ROLE INSTRUCTOR2_dba;
USE DATABASE INSTRUCTOR2_prod;
USE WAREHOUSE INSTRUCTOR2_small_query_wh;
...
USE ROLE INSTRUCTOR2_dev;
USE INSTRUCTOR2_prod.sales;
USE WAREHOUSE INSTRUCTOR2_small_query_wh;
...
USE ROLE INSTRUCTOR2_elt;
USE DATABASE INSTRUCTOR2_prod;
USE WAREHOUSE INSTRUCTOR2_elt_wh;
...
USE ROLE INSTRUCTOR2_analyst;
USE DATABASE INSTRUCTOR2_prod;
USE WAREHOUSE INSTRUCTOR2_elt_wh;
USE WAREHOUSE INSTRUCTOR2_large_query_wh;
...
GRANT CREATE USER ON ACCOUNT TO ROLE INSTRUCTOR2_manage_db;
...
GRANT OPERATE, MONITOR ON WAREHOUSE INSTRUCTOR2_elt_wh TO ROLE INSTRUCTOR2_manage_db;
GRANT OPERATE, MONITOR ON WAREHOUSE INSTRUCTOR2_mc_wh TO ROLE INSTRUCTOR2_manage_db;
GRANT OPERATE, MONITOR ON WAREHOUSE INSTRUCTOR2_small_query_wh TO ROLE INSTRUCTOR2_manage_db;
GRANT OPERATE, MONITOR ON WAREHOUSE INSTRUCTOR2_large_query_wh TO ROLE INSTRUCTOR2_manage_db;
...
CREATE USER INSTRUCTOR2_test_user;
GRANT ROLE INSTRUCTOR2_dba TO USER INSTRUCTOR2_test_user;

ALTER WAREHOUSE INSTRUCTOR2_elt_wh RESUME;
ALTER WAREHOUSE INSTRUCTOR2_elt_wh SUSPEND;

ALTER WAREHOUSE INSTRUCTOR2_small_query_wh
...
SELECT * FROM INSTRUCTOR2_prod.sales.partners;
...
REVOKE SELECT ON TABLE INSTRUCTOR2_prod.sales.partners
   FROM ROLE INSTRUCTOR2_read;
...
USE ROLE INSTRUCTOR2_dba;
REVOKE SELECT ON TABLE INSTRUCTOR2_prod.sales.dev_sales_tbl
   FROM ROLE INSTRUCTOR2_read;

USE ROLE INSTRUCTOR2_analyst;
SELECT * FROM INSTRUCTOR2_prod.sales.dev_sales_tbl;
...
DROP ROLE INSTRUCTOR2_dba;
DROP ROLE INSTRUCTOR2_dev;
DROP ROLE INSTRUCTOR2_elt;
DROP ROLE INSTRUCTOR2_analyst;

DROP ROLE INSTRUCTOR2_read;
DROP ROLE INSTRUCTOR2_ins_del;
DROP ROLE INSTRUCTOR2_create_objects;
DROP ROLE INSTRUCTOR2_manage_db;

DROP USER INSTRUCTOR2_test_user;
...
DROP DATABASE INSTRUCTOR2_prod;
...
DROP WAREHOUSE INSTRUCTOR2_small_query_wh;
DROP WAREHOUSE INSTRUCTOR2_large_query_wh;
DROP WAREHOUSE INSTRUCTOR2_elt_wh;
DROP WAREHOUSE INSTRUCTOR2_mc_wh;
