...
CREATE OR REPLACE PIPE INSTRUCTOR2_db.citibike.trips_pipe  AS
  COPY INTO INSTRUCTOR2_db.citibike.trips
    FROM (SELECT *
    FROM @TRAINING_DB.TRAININGLAB.CLASS_STAGE/COURSE/ADVANCED/INSTRUCTOR2)
...
COPY INTO @TRAINING_DB.TRAININGLAB.CLASS_STAGE/COURSE/ADVANCED/INSTRUCTOR2/citibike1_
...
LS @TRAINING_DB.TRAININGLAB.CLASS_STAGE/COURSE/ADVANCED/INSTRUCTOR2;
...
ALTER PIPE INSTRUCTOR2_db.citibike.trips_pipe REFRESH;

SELECT system$pipe_status('INSTRUCTOR2_db.citibike.trips_pipe');
...
COPY INTO @TRAINING_DB.TRAININGLAB.CLASS_STAGE/COURSE/ADVANCED/INSTRUCTOR2/citibike2_
  FROM  (SELECT *  FROM CITIBIKE.SCHEMA1.TRIPS SAMPLE(10 ROWS))
   FILE_FORMAT = (FORMAT_NAME = training_db.traininglab.MYGZIPPIPEFORMAT)
   OVERWRITE = TRUE;
