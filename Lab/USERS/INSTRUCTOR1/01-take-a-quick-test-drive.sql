...
CREATE DATABASE INSTRUCTOR1_db;
CREATE SCHEMA INSTRUCTOR1_db.myschema;
CREATE WAREHOUSE INSTRUCTOR1_wh INITIALLY_SUSPENDED=TRUE AUTO_SUSPEND=300;
CREATE WAREHOUSE INSTRUCTOR1_wh_small WAREHOUSE_SIZE=SMALL INITIALLY_SUSPENDED=TRUE AUTO_SUSPEND=300;
CREATE WAREHOUSE INSTRUCTOR1_wh_large WAREHOUSE_SIZE=LARGE INITIALLY_SUSPENDED=TRUE AUTO_SUSPEND=300;
...
USE ROLE TRAINING_ROLE;
USE WAREHOUSE INSTRUCTOR1_wh_small;
...
ALTER USER INSTRUCTOR1
    SET
    DEFAULT_ROLE=TRAINING_ROLE
    DEFAULT_NAMESPACE=INSTRUCTOR1_DB.PUBLIC
    DEFAULT_WAREHOUSE=INSTRUCTOR1_wh_small;
