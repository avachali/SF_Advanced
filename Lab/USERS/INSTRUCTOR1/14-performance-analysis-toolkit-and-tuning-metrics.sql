...
ALTER WAREHOUSE INSTRUCTOR1_query_wh RESUME;
...
SHOW PARAMETERS IN WAREHOUSE INSTRUCTOR1_query_wh;
...
ALTER WAREHOUSE INSTRUCTOR1_query_wh SET STATEMENT_TIMEOUT_IN_SECONDS = 30;
...
ALTER WAREHOUSE INSTRUCTOR1_query_wh UNSET STATEMENT_TIMEOUT_IN_SECONDS;
...
ALTER SESSION SET QUERY_TAG = 'INSTRUCTOR1_join_test';
...
SELECT query_id, query_tag 
  ...
  WHERE query_tag LIKE '%INSTRUCTOR1%';
