...
SHOW WAREHOUSES LIKE 'INSTRUCTOR1%';
...
ALTER WAREHOUSE INSTRUCTOR1_LOAD_WH SET AUTO_SUSPEND = 60;
...
--         If you get the message, Invalid State. Warehouse INSTRUCTOR1_LOAD_WH
...
ALTER WAREHOUSE INSTRUCTOR1_QUERY_WH SET WAREHOUSE_SIZE = 'X-LARGE';

SHOW WAREHOUSES LIKE 'INSTRUCTOR1_QUERY_WH';

ALTER WAREHOUSE INSTRUCTOR1_QUERY_WH SET WAREHOUSE_SIZE = 'MEDIUM';
...
ALTER WAREHOUSE INSTRUCTOR1_QUERY_WH SET WAREHOUSE_SIZE=LARGE;
...
ALTER WAREHOUSE INSTRUCTOR1_QUERY_WH SUSPEND;

ALTER WAREHOUSE INSTRUCTOR1_QUERY_WH SET WAREHOUSE_SIZE=XLARGE;
...
CREATE OR REPLACE WAREHOUSE INSTRUCTOR1_SCALE_OUT_WH 
...
SHOW WAREHOUSES LIKE 'INSTRUCTOR1_SCALE_OUT_WH';
